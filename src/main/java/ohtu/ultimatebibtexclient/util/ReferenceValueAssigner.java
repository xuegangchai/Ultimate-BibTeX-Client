...
public class ReferenceValueAssigner {
    ...
    public void assignReferenceVariables(HttpServletRequest req, Reference ref) throws IllegalAccessException, InvocationTargetException {
        /*
         * We require special handling for empty values, hence not using
         * @ModelAttribute. Specifically, if the value is null, we don't set it.
         * If the value is an empty string, we set it to null. Also, this
         * approach may be safer. See
